<nav id="sidebar-menu" class="collapse d-lg-block sidebar collapse bg-dark border-1">
    <div class="position-sticky">
        ...
        <div class="list-group list-group-flush  mt-0">
            <a href="/dashboard" class="list-group-item list-group-item-action px-3 border-0 bg-light border-0 active" aria-current="true">
                <i class="fas fa-tachometer-alt fa-fw me-3"></i><span> DASHBOARD</span>
            </a>
            <a href="/customer" class="list-group-item list-group-item-action px-3 border-0 bg-light border-0 ">
